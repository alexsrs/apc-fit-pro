 ...
 * Utiliza o ModalPadrao para manter consistência visual
 */
            ...
            <>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm">{avaliacao.userPerfil.user.name}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm">{avaliacao.userPerfil.user.email}</p>
                </div>
              </div>
            </>
          )}
